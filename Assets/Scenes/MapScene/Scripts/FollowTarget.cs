...
public class FollowTarget : MonoBehaviour {
    ...
    public float distanceToTargetXZ = 0.0f;    // The distance in the XZ plane to the target
    public float heightOverTarget = 0.0f;
    public float heightSmoothingSpeed = 0.0f;
    public float rotationSmoothingSpeed = 0.0f;
